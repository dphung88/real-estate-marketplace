          ...
          <div className="contact-wrapper">
            ...
            <div className="contact-info-box">
              ...
              <div className="social-links">
                ...
                <a href="https://www.tiktok.com/@mceagle.mentor" className="social-btn" aria-label="TikTok" target="_blank" rel="noopener noreferrer"><i className="fab fa-tiktok"></i></a>
                <a href="https://youtube.com/@mceagle.essentials" className="social-btn" aria-label="YouTube"><i className="fab fa-youtube"></i></a>
              </div>
            </div>
