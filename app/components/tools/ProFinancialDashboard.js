          ...
          <table className="w-full text-left" style={{ tableLayout: 'fixed', minWidth: '1000px' }}>
            ...
            <tbody>
              ...
              <tr className="group transition-colors hover:bg-black/[0.02] border-t border-black/5">
                <td style={{ padding: '20px 0', fontSize: '1rem', fontWeight: '400', color: '#666666', letterSpacing: '0.2px' }}>
                  Liquid Assets & Short-term
                </td>
                <td className="px-6 py-5 align-top text-center border-l border-black/5">
                ...
                <td className="px-8 py-5 align-top border-l border-black/5">
                  <div className="flex justify-between items-center w-full bg-[#F9F9F9] rounded-lg px-4 py-2">
                ...
                <td className="px-6 py-5 text-center border-l border-black/5 bg-[#F9F9F9]/50">
              ...
              <tr className="group transition-colors hover:bg-black/[0.02] border-t border-black/5">
                ...
                <td className="px-8 py-5 align-top border-l border-black/5">
                  <div className="flex flex-col gap-3 w-full">
                    <div className="flex justify-between items-center bg-[#F9F9F9] rounded-lg px-4 py-2">
                ...
                <td className="px-6 py-5 text-center border-l border-black/5 bg-[#F9F9F9]/50 align-top">
              ...
              <tr className="group transition-colors hover:bg-black/[0.02] border-t border-black/5">
                ...
                <td className="px-8 py-5 border-l border-black/5">
                  <div className="flex flex-col gap-3 w-full">
                    <div className="flex justify-between items-center bg-[#F9F9F9] rounded-lg px-4 py-2">
                ...
                <td className="px-6 py-5 text-center border-l border-black/5 align-bottom">
