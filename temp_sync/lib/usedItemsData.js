...
export const ALL_ITEMS = [
  ...
  { id: 7, title: 'John Deere Riding Mower', category: 'lawnmowers', location: 'Chicago, IL', price: 1800, condition: 'good', description: '2019 model, 200 hours of use, good condition, clean and serviced.', image: mowerFull, images: [mowerFull, mowerRideOn, mowerGrass, mowerField] },
  { id: 8, title: 'Husqvarna Zero Turn Mower', category: 'lawnmowers', location: 'Oak Park, IL', price: 3200, condition: 'excellent', description: '2021 model, 42" deck, hydrostatic drive, low hours.', image: mowerFull, images: [mowerFull, mowerRideOn, mowerGrass, mowerField] },
  { id: 9, title: 'Toro Push Mower 22"', category: 'lawnmowers', location: 'Chicago, IL', price: 220, condition: 'good', description: 'Self-propelled, electric start, mulching capability.', image: mowerFull, images: [mowerFull, mowerRideOn, mowerGrass, mowerField] },
  { id: 10, title: 'Cub Cadet XT1', category: 'lawnmowers', location: 'Wheaton, IL', price: 1450, condition: 'excellent', description: '2018 model, 42" cut, bagger included, garage kept.', image: mowerFull, images: [mowerFull, mowerRideOn, mowerGrass, mowerField] },
  { id: 11, title: 'Snapper Riding Mower', category: 'lawnmowers', location: 'Chicago, IL', price: 950, condition: 'good', description: '30" deck, 12.5 HP, reliable for small yards.', image: mowerFull, images: [mowerFull, mowerRideOn, mowerGrass, mowerField] },
  { id: 12, title: 'Greenworks 40V Cordless Mower', category: 'lawnmowers', location: 'Evanston, IL', price: 380, condition: 'excellent', description: 'Battery-powered, quiet, includes 2 batteries and charger.', image: mowerFull, images: [mowerFull, mowerRideOn, mowerGrass, mowerField] },
